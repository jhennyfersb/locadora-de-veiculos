...
INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE, PLACA)
VALUES (SEQ_VEICULO.nextval, 'hyundai', 'Creta', 'Branco', 2019, 300200, 200, 'ALUGADO', 'MCN0932');
INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE, PLACA)
VALUES (SEQ_VEICULO.nextval, 'Mercedes-Benz', 'GLB', 'Cinza', 2022, 50200, 1200, 'ALUGADO', 'INT7463');

INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE, PLACA)
VALUES (SEQ_VEICULO.nextval, 'Chevrolet', 'Corsa Premium', 'Preto', 2009, 56000, 120, 'ALUGADO', 'VAR3121');
INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE, PLACA)
VALUES (SEQ_VEICULO.nextval, 'Chevrolet', 'Onix', 'Prata', 2016, 98000, 220, 'ALUGADO', 'LUI2924');
INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE, PLACA)
VALUES (SEQ_VEICULO.nextval, 'Volkswagem', 'Gol G6', 'Vermelho', 2020, 87000, 200, 'ALUGADO', 'KAR0620');
INSERT INTO VEICULO (ID_VEICULO, MARCA, MODELO, COR, ANO, QUILOMETRAGEM, VALOR_LOCACAO_DIARIO, DISPONIBILIDADE, PLACA)
VALUES (SEQ_VEICULO.nextval, 'Renault', 'Clio', 'Branco', 2010, 70000, 130, 'ALUGADO', 'TUL0932');

SELECT * FROM VEICULO;

INSERT INTO FUNCIONARIO (ID_FUNCIONARIO, NOME_FUNCIONARIO, CPF_FUNCIONARIO, EMAIL_FUNCIONARIO, MATRICULA)
VALUES (SEQ_FUNCIONARIO.nextval, 'Dudu do Palmeiras', '85235795125', 'dudu@javamail.com.br', '123');
INSERT INTO FUNCIONARIO (ID_FUNCIONARIO, NOME_FUNCIONARIO, CPF_FUNCIONARIO, EMAIL_FUNCIONARIO, MATRICULA)
VALUES (SEQ_FUNCIONARIO.nextval, 'Luciano Huck', '89512595125', 'luciano@javamail.com.br', '456');
INSERT INTO FUNCIONARIO (ID_FUNCIONARIO, NOME_FUNCIONARIO, CPF_FUNCIONARIO, EMAIL_FUNCIONARIO, MATRICULA)
VALUES (SEQ_FUNCIONARIO.nextval, 'Michael Jackson', '19735795108', 'michael@javamail.com.br', '789');
INSERT INTO FUNCIONARIO (ID_FUNCIONARIO, NOME_FUNCIONARIO, CPF_FUNCIONARIO, EMAIL_FUNCIONARIO, MATRICULA)
VALUES (SEQ_FUNCIONARIO.nextval, 'Silvio Santos', '98563210444', 'silvio@javamail.com.br', '145');

INSERT INTO FUNCIONARIO (ID_FUNCIONARIO, NOME_FUNCIONARIO, CPF_FUNCIONARIO, EMAIL_FUNCIONARIO, MATRICULA)
VALUES (SEQ_FUNCIONARIO.nextval, 'Maria fernandes', '52355125209', 'maria@javamail.com.br', '369');
INSERT INTO FUNCIONARIO (ID_FUNCIONARIO, NOME_FUNCIONARIO, CPF_FUNCIONARIO, EMAIL_FUNCIONARIO, MATRICULA)
VALUES (SEQ_FUNCIONARIO.nextval, 'Eva Nunes', '99512595025', 'eva@javamail.com.br', '586');
INSERT INTO FUNCIONARIO (ID_FUNCIONARIO, NOME_FUNCIONARIO, CPF_FUNCIONARIO, EMAIL_FUNCIONARIO, MATRICULA)
VALUES (SEQ_FUNCIONARIO.nextval, 'Lucas Souza', '89735795105', 'lucas@javamail.com.br', '776');
INSERT INTO FUNCIONARIO (ID_FUNCIONARIO, NOME_FUNCIONARIO, CPF_FUNCIONARIO, EMAIL_FUNCIONARIO, MATRICULA)
VALUES (SEQ_FUNCIONARIO.nextval, 'Nathanael Queiroz', '18554210444', 'nathanael@javamail.com.br', '195');

INSERT INTO FUNCIONARIO (ID_FUNCIONARIO, NOME_FUNCIONARIO, CPF_FUNCIONARIO, EMAIL_FUNCIONARIO, MATRICULA)
VALUES (SEQ_FUNCIONARIO.nextval, 'Nikola Tesla', '35184287612', 'nikola@javamail.com.br', '140');
INSERT INTO FUNCIONARIO (ID_FUNCIONARIO, NOME_FUNCIONARIO, CPF_FUNCIONARIO, EMAIL_FUNCIONARIO, MATRICULA)
VALUES (SEQ_FUNCIONARIO.nextval, 'Thomas Edison', '98531647862', 'thomas@javamail.com.br', '220');
INSERT INTO FUNCIONARIO (ID_FUNCIONARIO, NOME_FUNCIONARIO, CPF_FUNCIONARIO, EMAIL_FUNCIONARIO, MATRICULA)
VALUES (SEQ_FUNCIONARIO.nextval, 'Michael Faraday', '97963521584', 'mich@javamail.com.br', '333');
INSERT INTO FUNCIONARIO (ID_FUNCIONARIO, NOME_FUNCIONARIO, CPF_FUNCIONARIO, EMAIL_FUNCIONARIO, MATRICULA)
VALUES (SEQ_FUNCIONARIO.nextval, 'Albert Einstein', '97956412853', 'albert@javamail.com.br', '240');
...
INSERT INTO CLIENTE (ID_CLIENTE, NOME_CLIENTE, CPF_CLIENTE, ID_CONTATO, ID_ENDERECO)
